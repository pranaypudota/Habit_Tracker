...
# For a local-first single-user app, we can use a hardcoded key. 
# In a real cloud app, this would be an environment variable.
SECRET_KEY = "habit-tracker-local-gate-key-change-me-later"
ALGORITHM = "HS256"
