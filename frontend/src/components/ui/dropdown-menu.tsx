...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-[9999] min-w-48 overflow-hidden rounded-lg border border-border bg-surface-2 p-1 text-popover-foreground shadow-lg shadow-black/10",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      "focus:bg-accent/50 focus:text-popover-foreground",
      "data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      "hover:bg-accent/30 hover:text-popover-foreground",
      inset && "pl-8",
      className
    )}
    {...props}
